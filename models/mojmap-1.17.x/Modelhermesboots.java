...
public class Modelhermesboots<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hermesboots"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftBoot = partdefinition.addOrReplaceChild("LeftBoot",
				CubeListBuilder.create().texOffs(0, 57)
						.addBox(-2.0F, 6.0F, -3.0F, 5.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 57)
		...
		PartDefinition RightBoot = partdefinition.addOrReplaceChild("RightBoot",
				CubeListBuilder.create().texOffs(35, 35)
						.addBox(-3.0F, 6.0F, -2.0F, 1.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(54, 33)
