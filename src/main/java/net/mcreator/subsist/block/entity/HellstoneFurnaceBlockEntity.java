package net.mcreator.subsist.block.entity;
...
import net.mcreator.subsist.init.SubsistModBlockEntities;
...
public class HellstoneFurnaceBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new HellstoneFurnaceGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return new TextComponent("Hellstone Furnace");
	}
