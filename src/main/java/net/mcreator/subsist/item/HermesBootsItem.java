			...
			consumer.accept(new IItemRenderProperties() {
				...
				public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("left_leg",
							new Modelhermesboots(Minecraft.getInstance().getEntityModels().bakeLayer(Modelhermesboots.LAYER_LOCATION)).LeftBoot,
							"right_leg",
							new Modelhermesboots(Minecraft.getInstance().getEntityModels().bakeLayer(Modelhermesboots.LAYER_LOCATION)).RightBoot,
