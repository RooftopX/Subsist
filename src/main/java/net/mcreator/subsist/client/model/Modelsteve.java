...
public class Modelsteve<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("subsist", "modelsteve"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = partdefinition
				.addOrReplaceChild("RightLeg",
						CubeListBuilder.create().texOffs(0, 33).addBox(-3.0F, 7.0F, -3.0F, 5.0F, 5.0F, 6.0F, new CubeDeformation(0.0F))
								.texOffs(22, 33).addBox(-4.0F, 7.0F, 0.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
