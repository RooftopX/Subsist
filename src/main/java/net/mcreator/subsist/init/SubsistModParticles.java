...
import net.mcreator.subsist.client.particle.HermesbootscloudParticle;
...
public class SubsistModParticles {
	private static final Map<ParticleType<?>, Function<SpriteSet, ParticleProvider<SimpleParticleType>>> REGISTRY = new HashMap<>();
	public static final SimpleParticleType HERMESBOOTSCLOUD = register(new SimpleParticleType(true).setRegistryName("hermesbootscloud"),
			HermesbootscloudParticle::provider);
