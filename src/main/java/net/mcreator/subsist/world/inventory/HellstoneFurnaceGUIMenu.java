...
public class HellstoneFurnaceGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HellstoneFurnaceGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SubsistModMenus.HELLSTONE_FURNACE_GUI, id);
